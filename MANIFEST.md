...
- xmake 版本：3.0.5（源码：xmake-io/xmake v3.0.5 tarball）
- 发布日期：2025-11-25T00:56:34Z
- 注解内容：纯源码生成 + 官方文档合并，由 tools/gen_annotations.py（main 分支 053ffb6）生成
- 文档合并层：xmake-io/xmake-docs @ 2dbc769e1267fb8d3a9ab9265212884b2bd89709（按发布日期映射：不晚于发布日期的最后一个 commit；zh 镜像优先、英文兜底）
- 生成统计：
```
文档: xmake-io/xmake-docs @ 2dbc769e1267fb8d3a9ab9265212884b2bd89709（381 个 API 条目）
...
文档覆盖（DSL 注册表 441 个 API）: 描述 376, 类型签名 375
文档覆盖（DSL 去重后 242 个函数）: 描述 201, 类型签名 200
