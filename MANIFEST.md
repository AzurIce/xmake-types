...
- xmake 版本：3.0.9（源码：xmake-io/xmake v3.0.9 tarball）
- 发布日期：2026-05-19T01:23:57Z
- 注解内容：纯源码生成 + 官方文档合并，由 tools/gen_annotations.py（main 分支 053ffb6）生成
- 文档合并层：xmake-io/xmake-docs @ 300d06b81845eef88ff070cb4aaed515336f26bf（按发布日期映射：不晚于发布日期的最后一个 commit；zh 镜像优先、英文兜底）
- 生成统计：
```
文档: xmake-io/xmake-docs @ 300d06b81845eef88ff070cb4aaed515336f26bf（451 个 API 条目）
...
```
- 生成时间：2026-09-01T10:28:58+00:00
