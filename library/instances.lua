...
-- 目标实例（project/target.lua，140 个公开方法）
---@class Target
...
---@field check_alignof fun(self: Target, typename: any, opt?: table): any
...
---@field memcache fun(self: Target): any
...
-- 包实例（package/package.lua，174 个公开方法）
---@class Package
...
---@field check_alignof fun(self: Package, typename: any, opt?: table): any
...
---@field current_scheme fun(self: Package): any
---@field current_scheme_set fun(self: Package, scheme: any): any
...
---@field has_addon fun(self: Package, opt?: table): any
...
---@field is_plugin fun(self: Package): any
...
---@field memcache fun(self: Package): any
...
---@field prepare_install_scheme fun(self: Package, scheme: any): any
...
---@field scheme fun(self: Package, name: string): any
---@field schemes fun(self: Package): any
---@field schemes_orderlist fun(self: Package): any
...
---@field use_precompiled_artifacts fun(self: Package, artifacts_info: any): any
