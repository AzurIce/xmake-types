...
-- os.vrun：仅在 verbose 模式回显并运行原生 shell 命令
---@param cmd string
---@param ... any
---@return any
function os.vrun(cmd, ...) end

-- os.vrunv：仅在 verbose 模式回显并运行原生 shell 命令，带参数列表
---@param program string
---@param argv table
---@param opt? table
---@return any
...
---@param version any
---@return any
function semver.is_valid(version) end

-- semver.is_valid_range
---@param range any
---@return any
function semver.is_valid_range(range) end
...
-- utils.bin2c：转换函数 <Badge type="tip" text="v3.1.0" />
