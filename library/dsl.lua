...
-- 单值设置（set_xxx / add_xxx）（111 个）

-- add_addons
---@param ... any
function add_addons(...) end

-- option.add_aicpuflags / package.add_aicpuflags / target.add_aicpuflags / toolchain.add_aicpuflags
---@param ... any
function add_aicpuflags(...) end
...
-- option.add_ascflags / package.add_ascflags / target.add_ascflags / toolchain.add_ascflags
---@param ... any
function add_ascflags(...) end

-- option.add_ascnpuarchs / target.add_ascnpuarchs / toolchain.add_ascnpuarchs
---@param ... any
function add_ascnpuarchs(...) end
...
-- option.add_csflags / target.add_csflags / toolchain.add_csflags
---@param ... any
...
-- target.add_vectorexts / option.add_vectorexts / package.add_vectorexts
-- 添加向量扩展指令
